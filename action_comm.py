...
class actionOBOS:
    ...
    def __init__(self,action_type):
        assert action_type in ["OB", "OS", "B3","B4","B32"],"{0} does not support {1}".format(self.__class__.__name__, self.action_type)
    ...
    def sanity_check_action_config(self,lc):
        ...
        elif self.action_type in ["B3","B4","B32"]:
            assert lc.action_type_dict[0] == "buy"
            assert lc.action_type_dict[1] == "no_action"
            assert lc.action_type_dict[2] == "sell"
            assert lc.action_type_dict[3] == "no_action"
    ...
    def I_TD_buffer(self,actionarray):
        ...
        elif self.action_type in ["B3","B32","B4"]:
    ...
    def _action_2_actionarray(self, action):
        a_onehot_shape= (1,4) if self.action_type in ["OB", "OS"] else (1, 5)  # else self.action_type in ["B3", "B4","B32"]
    ...
    def _get_prob_from_AParray(self,AParray, action):
        ...
        elif self.action_type in ["B3","B32"]:
