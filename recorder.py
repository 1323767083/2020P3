...
class record_variable_DBTP(DBTP_Reader):
    ...
    def _compress_content(self, inputs):
        ...
        for idx in range(len(s_lv)):
            to_saved_item_dic={
                ...
                "s_av":s_av[idx][0],
                "s__av": s__av[idx][0],
                #remove "flag_force_sell" "flag_force_sell":l_support_view[idx][0,0]['flag_force_sell'],
    ...
    def read_SC_CC_data(self, sc, cc):
        ...
        for raw_state in raw_states:
            ...
            #remove "flag_force_sell" support_view["flag_force_sell"] = raw_state["flag_force_sell"]
