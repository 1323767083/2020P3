...
from DBTP_Reader import DBTP_Train_Reader, DBTP_Eval_Reader
...
'''
class Simulator_intergrated_old:            #Simulator_LHPP2V8:
...
class Simulator_intergrated:
    def __init__(self, data_name, stock,StartI, EndI,called_by):
        assert not lc.flag_multi_buy
        #self.called_by = called_by
        #self.data_name = data_name
        self.i_PSS = globals()[lc.CLN_AV_state]()
